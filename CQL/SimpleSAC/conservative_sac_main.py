...
from .data_utils import make_cql_dataset
from .env_utils import make

FLAGS_DEF = define_flags_with_default(
    env='lift',
    data_dir='/home/matthew/data/mh/low_dim.hdf5',
    config_dir='/home/matthew/config/cql.json',
...
def main(argv):
    ...
    eval_sampler = TrajSampler(make(FLAGS.data_dir, FLAGS.config_dir), FLAGS.max_traj_length)

    dataset_replay_buffer = ReplayBuffer(
        max_size=0, data=make_cql_dataset(FLAGS.data_dir)
    )
    ...
    for epoch in range(FLAGS.n_epochs):
        ...
        with Timer() as eval_timer:
            if epoch == 0 or (epoch + 1) % FLAGS.eval_period == 0:
                ...
                # TODO: how to handle this? where is this even in gym.env
